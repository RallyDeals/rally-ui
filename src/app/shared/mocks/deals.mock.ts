...
import type { DealsAnalyticsResponse } from '../../features/deals/interfaces/DealsAnalyticsResponse';
...
export const DUMMY_DEALS: DealOverview[] = [
  {
    ...
    sku: 'KBD-OBS-01',
    sellerId: 'a1b2c3d4-1111-4a1b-8c2d-000000000001',
    sellerName: 'Wrenfield Co.',
    originalPrice: 180,
    dealPrice: 135,
    dealStock: 200,
  ...
  },
  {
    ...
    category: 'Electronics',
    sku: 'AUD-AUR-09',
    sellerId: 'a1b2c3d4-2222-4a1b-8c2d-000000000002',
    sellerName: 'Coastal Co.',
    originalPrice: 250,
    dealPrice: 195,
    dealStock: 300,
  ...
  },
  {
    ...
    category: 'Home & Furniture',
    sku: 'LUG-VOY-01',
    sellerId: 'a1b2c3d4-4444-4a1b-8c2d-000000000004',
  ...
  },
  {
    ...
    category: 'Home & Furniture',
    sku: 'BAG-SUM-05',
    sellerId: 'a1b2c3d4-3333-4a1b-8c2d-000000000003',
    sellerName: 'Lumen Co.',
    originalPrice: 70,
    dealPrice: 45,
    dealStock: 120,
