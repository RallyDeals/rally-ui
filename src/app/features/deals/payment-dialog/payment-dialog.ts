...
@Component({
  ...
  styles: `
    ...
    .card-item:hover { border-color: #5B5FC7; }
    .card-item.selected { border-color: #5B5FC7; background: #f0f0ff; }
    ...
    .btn-primary { background: #5B5FC7; color: white; border: none; border-radius: 8px; padding: 12px 24px; font-weight: 600; cursor: pointer; width: 100%; font-size: 15px; }
    .btn-primary:disabled { opacity: 0.5; cursor: not-allowed; }
    .btn-secondary { background: transparent; color: #5B5FC7; border: 1px solid #5B5FC7; border-radius: 8px; padding: 10px 24px; font-weight: 600; cursor: pointer; width: 100%; font-size: 14px; }
